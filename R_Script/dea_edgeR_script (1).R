...
#build model matrix - specify the biological condition we are comparing
...
#PsA Lesional vs Healthy would be PsA_les - Healthy, 
#therefore based on the column order of the design matrix:
